...
\date	13/04/18
\brief
This file contains the implementation for level 5 of Get off my Lawn
...
*/
/******************************************************************************/
#include "Level5.h"				// Function declarations
...
void Level5_Load()
{
	...
	logic_components.Load_Level_Components(5);

	// Load level Tower Nodes
	logic_components.level_data->Create_Granny_Tower_Nodes(14, LEFT, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(14, RIGHT, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(10, UP, GRANDMA, TOWER_NULL);

	logic_components.level_data->Create_Tower_Nodes(22, LEFT, KIDS, K_T_POISON);
	logic_components.level_data->Create_Tower_Nodes(22, RIGHT, KIDS, K_T_SLOW);
	logic_components.level_data->Create_Tower_Nodes(30, UP, KIDS, K_T_STUN);
	logic_components.level_data->Create_Tower_Nodes(32, DOWN, KIDS, K_T_SHOOTING);
