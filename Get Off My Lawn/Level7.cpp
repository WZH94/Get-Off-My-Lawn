...
\date	13/04/18
\brief
This file contains the implementation for level 7 of Get off my Lawn
...
*/
/******************************************************************************/
#include "Level7.h"				// Function declarations
...
void Level7_Load()
{
	...
	logic_components.Load_Level_Components(7);

	// Load level Tower Nodes
	/******* SET THE TOWER POSITIONS HERE *******/
	logic_components.level_data->Create_Tower_Nodes(5, DOWN, KIDS, K_T_STUN);
	logic_components.level_data->Create_Granny_Tower_Nodes(13, RIGHT, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Tower_Nodes(17, DOWN, KIDS, K_T_SWING);
	logic_components.level_data->Create_Granny_Tower_Nodes(23, LEFT, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(29, UP, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Tower_Nodes(37, RIGHT, KIDS, K_T_SLOW);
	logic_components.level_data->Create_Tower_Nodes(45, DOWN, KIDS, K_T_SHOOTING);
