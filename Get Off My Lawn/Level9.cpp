...
\date	13/04/18
\brief
This file contains the implementation for level 9 of Get off my Lawn
...
#include "Level9.h"				// Function declarations
...
void Level9_Load()
{
	...
	Create_Path(RIGHT, PATH_STRAIGHT);
	Create_Path(RIGHT, PATH_STRAIGHT);
	logic_components.object_manager->Set_Rotation(); //rotates turning paths

	logic_components.Load_Level_Components(9); //loads level 9 resources

	// Load level Tower Nodes
	/******* SET THE TOWER POSITIONS HERE *******/
	logic_components.level_data->Create_Granny_Tower_Nodes(4, DOWN, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(17, UP, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(29, UP, GRANDMA, TOWER_NULL);

	logic_components.level_data->Create_Tower_Nodes(35, DOWN, KIDS, K_T_SWING);
	logic_components.level_data->Create_Tower_Nodes(37, UP, KIDS, K_T_STUN);
	logic_components.level_data->Create_Tower_Nodes(48, RIGHT, KIDS, K_T_SHOOTING);
	logic_components.level_data->Create_Tower_Nodes(49, RIGHT, KIDS, K_T_POISON);
	logic_components.level_data->Create_Tower_Nodes(55, RIGHT, KIDS, K_T_SLOW);
...
void Level9_Init()
{
	system_components.audio_manager->Stream_Music(MUSIC_LEVEL); // play music
	...
	Create_Wave_Indicator(logic_components.level_data->Get_Max_Waves()); //spawns wave indicators
}
