...
\date	13/04/18
\brief
This file contains the implementation for level 3 of Get off my Lawn
...
*/
/******************************************************************************/
#include "Level3.h"				// Function declarations
...
void Level3_Load()
{
	...
	logic_components.Load_Level_Components(3);

	// Load level Tower Nodes
	logic_components.level_data->Create_Granny_Tower_Nodes(1, UP, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(5, DOWN, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(6, DOWN, GRANDMA, TOWER_NULL);

	logic_components.level_data->Create_Tower_Nodes(13, UP, KIDS, K_T_SWING);
	logic_components.level_data->Create_Tower_Nodes(17, LEFT, KIDS, K_T_SHOOTING);
	logic_components.level_data->Create_Tower_Nodes(17, RIGHT, KIDS, K_T_SHOOTING);
