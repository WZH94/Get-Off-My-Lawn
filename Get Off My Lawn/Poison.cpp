...
*/
/******************************************************************************/
#include "Poison.h"           // Function declarations
...
/******************************************************************************/
/*!
Default constructor of Poison Towers
*/
/******************************************************************************/
Poison::Poison(
...
/******************************************************************************/
/*!
"Update" function of Poison Towers
*/
/******************************************************************************/
void Poison::Update(void)
{
	...
	else
	{
		...
		checkEnemy = (Combatant*)Find_Nearest_Enemy_Soldier(*this, this->Get_Range(), true, true);

		// No rushers found, search for any soldier
		if (checkEnemy == nullptr)
			checkEnemy = (Combatant*)Find_Nearest_Enemy_Soldier(*this, this->Get_Range(), false, true);
...
/******************************************************************************/
/*!
"Draw" function of Poison Towers
*/
/******************************************************************************/
void Poison::Draw()
{
