...
*/
/******************************************************************************/
#include "SlowDown.h"         // Function declarations
...
/******************************************************************************/
/*!
Default constructor of Slow Towers
*/
/******************************************************************************/
SlowDown::SlowDown(
...
/******************************************************************************/
/*!
"Update" function of Slow Towers
*/
/******************************************************************************/
void SlowDown::Update(void)
{
	...
	else
	{
		...
		checkEnemy = (Combatant*)Find_Nearest_Enemy_Soldier(*this, this->Get_Range(), true, false, true);

		// No rushers found, search for any soldier
		if (checkEnemy == nullptr)
			checkEnemy = (Combatant*)Find_Nearest_Enemy_Soldier(*this, this->Get_Range(), false, false, true);
