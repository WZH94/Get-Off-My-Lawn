...
\date	13/04/18
\brief
This file contains the implementation for level 2 of Get off my Lawn
...
*/
/******************************************************************************/
#include "Level2.h"				// Function declarations
...
void Level2_Load()
{
	...
	logic_components.Load_Level_Components(2); // loads level 2 components
	...
	logic_components.level_data->Create_Granny_Tower_Nodes(11, DOWN, GRANDMA, TOWER_NULL);

	logic_components.level_data->Create_Tower_Nodes(13, DOWN, KIDS, K_T_SHOOTING);
	logic_components.level_data->Create_Tower_Nodes(19, UP, KIDS, K_T_SHOOTING);
	logic_components.level_data->Create_Tower_Nodes(21, UP, KIDS, K_T_SHOOTING);
