...
\date	13/04/18
\brief
This file contains the implementation for level 4 of Get off my Lawn
...
*/
/******************************************************************************/
#include "Level4.h"				// Function declarations
...
void Level4_Load()
{
	...
	logic_components.Load_Level_Components(4);
	...
	logic_components.level_data->Create_Granny_Tower_Nodes(8, RIGHT, GRANDMA, TOWER_NULL);
	logic_components.level_data->Create_Granny_Tower_Nodes(9, RIGHT, GRANDMA, TOWER_NULL);

	logic_components.level_data->Create_Tower_Nodes(15, RIGHT, KIDS, K_T_POISON);
	logic_components.level_data->Create_Tower_Nodes(16, RIGHT, KIDS, K_T_SWING);
	logic_components.level_data->Create_Tower_Nodes(23, RIGHT, KIDS, K_T_SHOOTING);
